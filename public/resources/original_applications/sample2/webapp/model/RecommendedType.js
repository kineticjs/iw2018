sap.ui.define([
	...
	return SimpleType.extend("sap.ui.demo.bulletinboard.model.RecommendedType", {
		/**
		 * Formats the integer value from the model to a boolean for the pressed state of the flagged button
		 *
		 * @public
		 * @param {number} iRecommended the integer value of the formatted property
		 * @returns {boolean} 1 means true, all other numbers means false
		 */
		formatValue: function (iRecommended) {
			return iRecommended === 0;
		},
