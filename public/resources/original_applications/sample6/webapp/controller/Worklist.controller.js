	...
	return BaseController.extend("sap.ui.demo.bulletinboard.controller.Worklist", {
		...
		_onSearchMatched: function (oEvent) {
			...
			if (oQuery) {
				...
				iStart = window.location.href.indexOf(SEARCH_TERM);

				if (iStart> 0) {
					var sSearchTerm = window.location.href.substring(iStart + SEARCH_TERM.length);
					sSearchTerm = decodeURIComponent(sSearchTerm);
