	...
	function (jQuery, library, Control, Icon) {
		...
		var InfoBar = Control.extend("custom.InfoBar", {
			...
			renderer: function (rm, oControl) {
				...
				rm.write("<a");
				rm.writeAttribute("href", "mailto:" + oControl.getEmail()); // should be rm.writeAttributeEscaped(href, <...untrusted data...>)
				...
				rm.write("<a");
				rm.writeAttribute("href", oControl.getHomepageUrl()); // should be rm.writeAttributeEscaped(href, <...untrusted data...>)
				rm.writeAttribute("style", "margin: 0 0.2rem");
				rm.write(">");
